...
<%
	...
	if(totalSeat != null && date != null && destination != null && actionType.equals("search")){
		...
		<div class="ticket_info">
			<h2 style="background: #2a2a2a; color:#fff; padding:15px; border-radius:5px;">Ticket Details</h2>
			<table class="table">
				<tr>
					<td>
						<ul>
		...
		%>
		<div class="ticket_info">
			<h2 style="background: #2a2a2a; color:#fff; padding:15px;">Congratulation! Your ticket has been booked.</h2>
