	...
	<form class="register_form" style="max-width:400px;" action="<%= Helper.baseUrl %>TicketDisplay.jsp" method="post">
		<div class="rs_form_box">
			...
			<div class="form-group">
				...
				<select class="form-control" name="from" id="from_where_select" required>
					<%
			...
			<div class="form-group">
				...
				<select class="form-control" name="journey_date" id="from_where_select" required>
					<%
			...
			<div class="form-group">
				...
				<select class="form-control" name="to" id="from_where_select" required>
					<%
					for(int i =0; i<allStations.size(); i++){
						Station stn = allStations.get(i);
						%>
			...
			<div class="form-group">
				...
				<select class="form-control" name="coach" id="from_where_select" required>
