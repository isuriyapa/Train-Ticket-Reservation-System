			...
			<div class="col-xs-12 col-sm-6">
				<div class="rs_form_box">
					...
					<div class="input-group">
						...
						<input type="email" name="email" class="form-controller" required>
					</div>
					<div class="input-group">
						<label>Re-Enter Email address*</label>
						<input type="email" name="email_con" class="form-controller" required>
					</div>

					<div class="input-group">
						<label>Password*</label>
						<input type="password" name="password" class="form-controller" required>
					</div>

					<div class="input-group">
						<label>Re-Enter Password*</label>
						<input type="password" name="password_con" class="form-controller" required>
					</div>
